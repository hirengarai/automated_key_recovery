...
def gen_operator(bitsize, table, round, index):
...
def test_constant_add_1():

    op = gen_operator(1, [[1, 2], [3, 4]], round = 1, index = 0)
...
def test_constant_add_2():

    op = gen_operator(2, [[1, 2], [3, 4]], round = 2, index = 1)
