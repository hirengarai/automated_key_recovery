...
# --- Configuration ---
TRAIL_ROUNDS = 5  # rounds for the differential trail (distinguisher)
...
cipher = SKINNY_BLOCKCIPHER(r=TOTAL_ROUNDS, version=[64, 192])


print(f"Running key recovery on {TOTAL_ROUNDS}-round SKINNY-64/192...")
