...
# --- Configuration ---
TRAIL_ROUNDS =  2         # rounds for the differential trail (distinguisher)
EXTENSION_BEFORE = 3      # extension rounds prepended
EXTENSION_AFTER = 2       # extension rounds appended
...
cipher = SKINNY_BLOCKCIPHER(r=TOTAL_ROUNDS, version=[64, 64])


print(f"Running key recovery on {TOTAL_ROUNDS}-round SKINNY-64/64...")
